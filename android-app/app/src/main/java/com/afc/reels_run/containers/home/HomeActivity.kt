package com.afc.reels_run.containers.home
...
import com.afc.reels_run.databinding.ActivityHomeBinding
...
import com.afc.reels_run.exec.exit.ExitAppActivity
import com.afc.reels_run.models.auth.AuthModel
import com.afc.reels_run.models.game.CurrentGameModel
...
class HomeActivity : AppCompatActivity() {
    private val LOG_TITLE = "HOME_ACTIVITY"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (socket.value == null) {
            ...
            socketConnectionJob = socketConnection{
                Log.w(this.LOG_TITLE, "Подключение к сокету прошло успешно!")
            }
        }
        ...
        socket.observe(this) {
            Log.w(this.LOG_TITLE, "Обработка изменения подключения к сокету: ${it?.id()} ${it?.connected()}")
